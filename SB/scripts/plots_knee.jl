...
##########################################################################################################
############ Plots for illustrative examples of Section 4.2 (Hybrid submodular reformulation) ############
##########################################################################################################
...
savefig(FIGURES_PATH*"plot_knee_choice.png")
...
# Save the plot as a PNG file
savefig(FIGURES_PATH*"knee_time.png")

#Print statistics
println("\nAverage time SHS = ",y_auto)
...
# Save the plot as a PNG file
savefig(FIGURES_PATH*"knee_cuts.png")

#Print statistics
println("\nSHS: (#cuts, |P1|) = (",mean_n_cuts_auto,", ",mean_P1_auto,")")
println("SHS: # integer nodes B&C = ",mean_n_integer_nodes_BnC_auto)
