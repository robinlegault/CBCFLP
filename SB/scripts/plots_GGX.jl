...
# Dependencies
include("../source/Greedy_method.jl")
include("../source/IO_functions.jl")
include("../source/MNL_functions.jl")
include("../source/Plotting_functions.jl")
include("../source/SHS_method.jl")
include("../source/Simulation_and_clustering_functions.jl")
...
# SHS solution (optimal, identical to the solution returned by MOA; verified on the original MATLAB implementation)
(x_opt, Z_opt) = SHS(a, ω, b; return_stats=false)
...
savefig(FIGURES_PATH*"GGX_example_suboptimal.png")
...
savefig(FIGURES_PATH*"GGX_example_optimal.png")